      ...
      >
        <Grid width="35%" textAlign="left">
          ...
          <Typography variant="subtitle2" mt={2} mb={2}>
            Créez votre entreprise avec Click & Machin pour vendre en ligne,
            hors ligne et partout où se trouvent vos clients.
          </Typography>
      ...
      >
        ...
        <Grid width="35%" textAlign="center">
          <Typography fontWeight={600} variant="h4">
            Un point de vente flexible et click and collect pour propulser votre
            magasin
          </Typography>
          <Typography variant="subtitle2" mt={4} mb={4}>
            Un système point de vente click and collectpermettant aux clients
            d’effectuer leurs achats de façon flexible, en ligne ou en magasin.{" "}
          </Typography>
      ...
      >
        <Grid width="35%" textAlign="left">
          ...
          <Typography variant="subtitle2">
            Bla bla stat dash board ...Lorem ipsum dolor sit amet, consectetur
      ...
      <Grid container mt={25} alignItems="center" justifyContent="center">
        ...
        >
          <Typography variant="h5" sx={{ fontWeight: "bold" }}>
            « Je voulais pouvoir être libre de faire des modifications sur le
            site, comme changer des images ou modifier l’apparence du site.
            Collect & Verything m’apporte cette autonomie »
          </Typography>
          <Typography
            mt={5}
            sx={{
        ...
        >
          ...
          <Typography variant="subtitle2" pt={7}>
            Que vous souhaitiez vendre des produits localement ou à
            l’international,
          </Typography>
